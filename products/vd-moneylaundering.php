...
?>
    <div class="hero">
      <h1 class="hero__title"><?php echo $site; ?> | VD-MoneyLaundering</h1>
    </div>
    <div class="hero__terminal">
      <pre>
        <code class="shell-session vd-moneylaundering">VaughansDev ~ $ </code>
      </pre>
    </div>
    <div class="callout">
      <a href="https://vaughansdev.tebex.io/package/5262340" class="button--primary">Buy Now on Tebex!</a>
      <a href="../docs/vd-moneylaundering.php" class="button--primary">VD-MoneyLaundering Documentation</a>
    </div>
    <div class="wrapper">
      <div class="feature">
      ...
      <div class="callout">
        ...
        <a href="https://ontariosfinest.tk" class="button--primary">Click Here to Check Out Ontarios Finest</a>
      </div>
    </div>
<?php
